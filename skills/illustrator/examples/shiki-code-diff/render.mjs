...
/** @type {(fontStyle: number, bit: number) => boolean} */
...
/** @type {(token: import("shiki").ThemedToken) => Record<string, string | number | undefined>} */
...
/** @type {(value: number | null, backgroundColor: string, color: string) => ReturnType<typeof container>} */
...
/** @type {(entry: DiffEntry | null, highlighted: import("shiki").TokensResult, showDivider: boolean) => ReturnType<typeof container>} */
