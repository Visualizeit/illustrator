...
This identity works best when the main message names the benefit rather than describing the interface. Examples include “从重复中解放生产力”, “让工作自己流转”, and “一次编排，持续执行”.
